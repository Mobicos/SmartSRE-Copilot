...
All notable changes to SmartSRE Copilot are documented in this file.
...
- Native Agent Workbench baseline with workspace, scene, tool policy, run,
  event, feedback, history, and detail flows.
